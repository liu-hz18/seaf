...
FACTOR_REGISTRY = {
    ...
    'quality_basic': compute_quality_basic_factors,
...
FACTOR_PREFIXES = {
    ...
    'cross_section_neut': 'factor_cs',
}

__all__ = [
    'compute_momentum_factors', 'compute_volatility_factors',
    'compute_liquidity_factors', 'compute_value_factors',
    'compute_quality_basic_factors', 'compute_quality_autocorr_factors',
    'compute_quality_pattern_factors',
    'compute_trend_factors', 'compute_counting_factors',
